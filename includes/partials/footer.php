    ...
    <div class="footer-top">
      <div class="footer-brand">
        ...
        <div class="footer-social">
          <a class="social-btn" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
          <a class="social-btn" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
          <a class="social-btn" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
        </div>
      </div>
      <div>
